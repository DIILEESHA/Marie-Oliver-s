        ...
        <div className="tip-card">
          ...
          <div className="tip-card-content">
            <ul className="recommendation-list">
              ...
              <li className="ll_p">
                <strong>Le Amis</strong> – Modern cuisine (Port of Pounda)
              </li>
              <li className="ll_p">
              ...
              <li className="ll_p">
                <strong>Cuere Rosso</strong> – Pizza lovers (Parikia)
              </li>
              <li className="ll_p">
                <strong>Burger Street</strong> – Small burger spot (Parikia)
              </li>
              <li className="ll_p">
                <strong>Souvlaki cravings?</strong> – Try Masete or Pepe
                Souvlaki (Parikia port)
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="tip-card">
          ...
          <div className="tip-card-content">
            <ul className="recommendation-list">
              ...
              <li className="ll_p">
                <strong>Cabana</strong> – Stylish beach bar with music & events
              </li>
              <li className="ll_p">
                <strong>Crios Beach</strong> – Newer spot with lunch & events
              </li>
              <li className="ll_p">
        ...
        <div className="tip-card">
          ...
          <div className="tip-card-content">
            <div className="location-section">
              ...
              <ul className="recommendation-list">
                <li className="ll_p">
                  <strong>Boogaloo</strong> – Great for drinks on the main
                  square
                </li>
                <li className="ll_p">
                ...
                <li className="ll_p">
                  <strong>Lime Bar</strong> – Dance floor with commercial music
                </li>
              </ul>
            </div>
            ...
            <div className="location-section">
              ...
              <ul className="recommendation-list">
                ...
                <li className="ll_p">
                  <strong>La Diablita, Pirate Bar, Bebop, Dubliner</strong> –
                  Young crowd/club vibe
                </li>
              </ul>
            </div>
          </div>
